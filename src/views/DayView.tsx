...
export const DayView: React.FC<DayViewProps> = ({
  ...
  React.useEffect(() => {
    if (scrollContainerRef.current) {
      // Reversed mode: initialScrollHour sits near the bottom of the grid
  ...
  return (
    <div className="flex flex-col h-full min-h-0 bg-background border-[0.5px] border-border/50 rounded-2xl overflow-hidden shadow-sm">
        {/* Header */}
        ...
        {/* Grid — flex-1 + min-h-0 ensures this stays bounded and scrollable */}
            ...
            <div className="flex relative" style={{ height: hours.length * hourHeight }}>
                ...
                <div className="flex-1 relative">
                     ...
                     {dayEvents.map(event => {
                       ...
                       // In reversed mode, the event's visual top is at the END time's flipped position
